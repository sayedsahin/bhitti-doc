...
Bhitti is designed for developers who need more than a minimal router but do not want the complexity, hidden behavior or runtime overhead of a large full-stack framework.
...
## What Makes Bhitti Different

Bhitti combines a lightweight runtime with the practical features commonly required by production applications.
...
Bhitti takes a focused approach:
